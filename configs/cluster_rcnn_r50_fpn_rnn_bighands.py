...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + '_LABELLED_SAMPLES',
        seq_len=rnn_seq_len,
        step=5,
        pipeline=train_pipeline),        
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_vccal.json',
        img_prefix=data_root + '_LABELLED_SAMPLES',
    ...
    test=dict(
        ...
        img_prefix=data_root + 'all_frames',
        seq_len=rnn_seq_len,
        step=rnn_seq_len-1,
        pipeline=test_pipeline))
...
log_level = 'INFO'
work_dir = './work_dirs/cluster_rcnn_r50_fpn_rnn_bighands_lr00025'
load_from = './work_dirs/cluster_rcnn_r50_fpn_rnn_bighands_one_lr01/epoch_12.pth'
