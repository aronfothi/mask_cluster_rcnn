...
log_level = 'INFO'
work_dir = './work_dirs/cluster_rcnn_r50_fpn_rnn_rats_one_lr005'
load_from = 'https://s3.ap-northeast-2.amazonaws.com/open-mmlab/mmdetection/models/mask_rcnn_r50_fpn_1x_20181010-069fa190.pth'
#load_from = '/media/hdd/aron/pretrained_weights/yt_high/epoch_12.pth'
#load_from = './work_dirs/cluster_rcnn_r50_fpn_rnn_rats_5_lr0001_near/epoch_12.pth'
#resume_from = work_dir + '/epoch_5.pth'
resume_from = None
workflow = [('train', 1)]
