...
from .transforms import (bbox2delta, bbox2result, bbox2result_with_id, bbox2roi, bbox_flip,
...
__all__ = [
    ...
    'bbox_mapping_back', 'bbox2roi', 'roi2bbox', 'bbox2result', 'bbox2result_with_id',
